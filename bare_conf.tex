...
Bunun dışında arayüzü aşağıdaki "şekil td.jpg"'de görülen yardımcı araçlarda geliştirilmiştir. TrackDesigner aracı bunlardan en önemlisidir. Bu araç ile modellenecek anklaşman sahaları görsel olarak çizilmiş, saha gerçeğine uygun olarak modellenmiştir. TrackDesigner ile tren trafiğinde güvenliği sağlayan bir takım kuralları içeren anklaşman tablolarının üretilmesi gerçekleştirilmiştir. TrackDesignerîn benzer araçlardan \cite{FRISO} farkı sadece anklaşman tablosu değil trenlerin gideceği ray, makas, hemzemin geçit gibi saha ekipmanlarının pozisyonlarını metre hassasiyetinde modellemeye olanak sağlamasıdır. Böylece trenin hareket dinamikleri gerçeğine uygun olarak simüle edilebilmiştir. Sistemin ihtiyaç duyduğu verilerin hemen hemen hepsi TrackDesigner kullanılarak üretilmiştir.
...
\section{Conclusion}
Sonuç olarak RAYTES projesiyle ile tren trafiğini yöneten dispeçerlerin gerçek hayatta kaldıkları olaylar ve durumlar gerçeğine uygun olarak simüle edilerek mesleki eğitim almaları sağlanmıştır. Bu kapsamda Türkiye'nin farklı bölgelerindeki 3 tren hattı modellenmiş ve bilgisayar ortamında simüle edilmiştir. Eğitimlerin bilgisayar ortamında yapılması hem tren kazası, deray gibi gerçekte uygulamalı eğitimi verilemeyecek durumların dispeçerlere aktarılmasına hem de eğitim maliyetlerinin düşmesine katkı sağlamış, dispeçerlerin göreve başlamadan önce gerçekte karşılaşabilecekleri durumları tecrübe edip kriz durumlarında doğru karar alma ve krizi yönetme kabiliyetlerini geliştirmesine katkı sağlamıştır.
Computer Simulations can be considered as a powerful tool for learning such as analysing, designing, and interacting. Especially in the vital criticality level it has become more important tools such as train traffic simulation.
The most important purpose of train control system is to prevent train collisions with other trains, keeping them in safe range.
...
\bibitem{Söylemez}  U. Yıldırım, M.S. Durmuş ve M.T. Söylemez, “Demir yolu Sinyalizasyon Sistemleri İçin Otomatik Anklaşman Tablosu Oluşturulması”, EUSİS’11, Elektrikli Ulaşım Sist. Semp. ve Sergisi, Bursa-Eskişehir, Türkiye, 2011. - See more at: http://www.3eelectrotech.com.tr/arsiv/yazi/rayly-sistem-sinyalizasyon-tasarymy-ulusal-demir-yolu-sinyalizasyonu-projesi#sthash.i0kK9LjP.dpuf
